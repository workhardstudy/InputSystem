...
public class PatientDAO {
	...
	public ArrayList<Patient> queryPatientsBasic(String cyDeps, String cyDate1, String cyDate2) throws Exception {// 实现对数据库的访问
		...
		cyDate2 = "'" + cyDate2 + " 23:59:59.997'";
		String sql = "select row_number() over(order by FCYDEPT asc,convert(varchar,FCYDATE,23) asc,FPRN+cast(FTIMES as varchar) asc,FPRN asc,FTIMES asc) 行号"
				...
				+ ") and Fifinput=0"
				+ " order by FCYDEPT asc,convert(varchar,FCYDATE,23) asc,FPRN+cast(FTIMES as varchar) asc,FPRN asc,FTIMES asc;";
